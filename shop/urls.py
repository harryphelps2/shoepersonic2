...
urlpatterns = [
    ...
    re_path(r'^edit_comment_for_shoe/(?P<shoe_id>\d+)/(?P<comment_id>\d+)/$', edit_comment_for_shoe, name='edit_comment_for_shoe'),
    re_path(r'^delete_comment_for_shoe/(?P<shoe_id>\d+)/(?P<comment_id>\d+)/$', delete_comment_for_shoe, name='delete_comment_for_shoe'),
]